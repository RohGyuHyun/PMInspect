...
//	int m_iObjPitch;					// distance between objectives
	...
	char m_cLastCmnd[256];				// last LLC command 
...
public:
	...
	bool moveLlcToObjective2(int iObjectiveNumber, bool bWaitForEnd, int *piErrCode);
	bool moveLlcToObjectiveInt(int iObjectiveNumber, bool bWaitForEnd, bool bIgnoreInitStatus, int *piErrCode);
